  ...
  /******/ var __webpack_modules__ = {
    /***/ 265: /***/ (module, __webpack_exports__, __webpack_require__) => {
      ...
      var ___CSS_LOADER_URL_IMPORT_0___ = new URL(
        /* asset import */ __webpack_require__(920),
        __webpack_require__.b
      );
      var ___CSS_LOADER_URL_IMPORT_1___ = new URL(
        /* asset import */ __webpack_require__(27),
        __webpack_require__.b
      );
      ...
      ___CSS_LOADER_EXPORT___.push([
        module.id,
        "body{display:none}body.nemu iframe,body.nemu .weizhi,body.nemu .weizhi+div,body.nemu .at-share-btn,body.nemu .sao_mobile_box,body.nemu .addthis-animated,body.nemu .addthis-smartlayers,body.nemu .addthis-smartlayers-desktop,body.read iframe,body.read .weizhi,body.read .weizhi+div,body.read .at-share-btn,body.read .sao_mobile_box,body.read .addthis-animated,body.read .addthis-smartlayers,body.read .addthis-smartlayers-desktop{display:none !important}body.menu{background-color:#eee !important;background:url(" +
          ___CSS_LOADER_URL_REPLACEMENT_0___ +
          ') repeat;font-family:ËÎÌå, PingFangSC-Regular, HelveticaNeue-Light, "Helvetica Neue Light",\r "Microsoft YaHei", sans-serif !important}body.menu ._menu_content{margin:36px auto}body.menu ._menu_content a{color:#333 !important}body.menu ._menu_content a:visited{color:#555 !important}body.menu .box_con{background:url(' +
          ___CSS_LOADER_URL_REPLACEMENT_0___ +
          ") repeat}.shuquge.menu .book,.shuquge.menu .listmain{background:url(" +
          ___CSS_LOADER_URL_REPLACEMENT_0___ +
          ") repeat}body.read{background:url(" +
          ___CSS_LOADER_URL_REPLACEMENT_1___ +
          ') repeat;font-size:18px;font-family:PingFangSC-Regular, HelveticaNeue-Light,\r "Helvetica Neue Light", "Microsoft YaHei", sans-serif !important}body.read ._content{box-sizing:border-box;background:url(' +
          ___CSS_LOADER_URL_REPLACEMENT_0___ +
          ') repeat;width:800px;margin:1em auto 1em;padding:1em;color:#262626;font-weight:500;text-indent:2em;text-align:left;border:1px solid #d8d8d8}body.read ._content br{content:"";margin:0.5em 0;display:block;font-size:150%}body.read ._content p{word-wrap:wrap;word-break:break-all;margin-top:0.5em;line-height:1.5;text-align:justify}body.read ._content ._content_title{display:flex;align-items:center;text-indent:0;padding:0 0 0.5em;margin:0 0 0.5em;border-bottom:1px solid #d8d8d8;color:#cc3300}body.read ._content ._content_title span{font-size:12px;padding:0 1em;margin:0}body.read ._content_nav{box-sizing:border-box;background:url(' +
          ___CSS_LOADER_URL_REPLACEMENT_0___ +
          ") repeat;width:800px;margin:1em auto 1em;height:70px;display:flex;align-items:center;border:1px solid #d8d8d8}body.read ._content_nav a,body.read ._content_nav span{flex:1;height:100%;display:flex;align-items:center;justify-content:center;text-decoration:none;color:#333}body.read ._content_nav a:hover,body.read ._content_nav span:hover{background:url(" +
          ___CSS_LOADER_URL_REPLACEMENT_0___ +
          ') repeat}body.home{font-family:PingFangSC-Regular, HelveticaNeue-Light, "Helvetica Neue Light", "Microsoft YaHei",\r sans-serif !important}\n',
        ""
      ]);
      // Exports
...
*/
    ...
    /***/ 892: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
      /* istanbul ignore next  */
  ...
  (() => {
    ...
    var styles = __webpack_require__(265); // CONCATENATED MODULE: ./src/assets/styles/index.scss
    var options = {};
    ...
    /* harmony default export */ const assets_styles =
      styles /* default */.Z && styles /* default.locals */.Z.locals
        ? styles /* default.locals */.Z.locals
        : undefined; // CONCATENATED MODULE: ./src/components/ui.js
    ...
    UI.prototype.www81zw = function () {
      ...
      this.ads = [".ywtop", "#footer", ".header", "#listtj", ".box_con + script + div"];
      this.process();
    };

    /* harmony default export */ const ui = UI; // CONCATENATED MODULE: ./src/main.js
