...
// @name         小说整治
// @version      0.0.7
// @description  帮助你获得一致的小说阅读体验：支持UU看书，笔趣阁，书趣阁，81中文网
...
// @supportURL   https://github.com/gausszhou/user-scripts/tree/master/packages/readnovel
// @homepageURL  https://github.com/gausszhou/user-scripts/tree/master/packages/readnovel
// ==/UserScript==
...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(920), __webpack_require__.b);
...
UI.prototype.shuquge = function () {
  ...
  this.ads = [".ywtop", ".header", "div.box_con > div.bookname div.lm", ".info > .link", ".footer"];
  this.process();
};
