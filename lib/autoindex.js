...
// @name         Kiloview
// @version      0.0.1
// @description  Kiloview Image Helper
// @author       gausszhou@qq.com
// @namespace    gausszhou
// @grant        none
// @icon         https://www.kiloview.com/cn/wp-content/uploads/2021/04/cropped-logo-1-32x32.png
// @run-at       document-end
// @license      MIT
// @include      *://*.kiloview.com/data/*
// ==/UserScript==
/******/ (() => { // webpackBootstrap
/******/ 	"use strict";
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".kiloview{display:flex;flex-wrap:wrap}.kiloview img{width:200px}.kiloview .image-box{border:1px solid #333}.kiloview .image-name{text-align:center}\n", ""]);
// Exports
...
UI.prototype.init = function () {
  console.log("欢迎使用Kiloview Helper");
};
...
UI.prototype.process = function () {
  ...
  if (imgList.length) {
    ...
    this.body.classList.add("kiloview");
  }
};
